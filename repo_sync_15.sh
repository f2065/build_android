...
printf "\033]2;%s Sync LineageOS 15.1 - main sources...\007" $(date +"%Y-%m-%d_%H:%M:%S")
echo "*** main sources..."
cd ~/src_M2_LOS151
...
printf "\033]2;%s Sync LineageOS 15.1 - gps fix..\007" $(date +"%Y-%m-%d_%H:%M:%S")
echo "*** gps fix..."
cd ~/src_M2_LOS151
rm -rf hardware/qcom/gps
git clone https://github.com/f2065/android_hardware_qcom_gps -b lineage-15.1 hardware/qcom/gps

printf "\033]2;%s Sync LineageOS 15.1 - boringssl-compat...\007" $(date +"%Y-%m-%d_%H:%M:%S")
...
printf "\033]2;%s Sync LineageOS 15.1 - sony_timekeep...\007" $(date +"%Y-%m-%d_%H:%M:%S")
echo "*** sony_timekeep..."
if [[ $src_init -eq 1 ]]; then
cd ~/src_M2_LOS151
...
printf "\033]2;%s Sync LineageOS 15.1 - qcom_common...\007" $(date +"%Y-%m-%d_%H:%M:%S")
echo "*** qcom_common..."
if [[ $src_init -eq 1 ]]; then
cd ~/src_M2_LOS151
...
printf "\033]2;%s Sync LineageOS 15.1 - sony_common...\007" $(date +"%Y-%m-%d_%H:%M:%S")
echo "*** sony_common..."
if [[ $src_init -eq 1 ]]; then
cd ~/src_M2_LOS151
...
printf "\033]2;%s Sync LineageOS 15.1 - sony_macaddrsetup...\007" $(date +"%Y-%m-%d_%H:%M:%S")
...
# printf "\033]2;%s Sync LineageOS 15.1 - sony_thermanager...\007" $(date +"%Y-%m-%d_%H:%M:%S")
...
printf "\033]2;%s Sync LineageOS 15.1 - devicesettings...\007" $(date +"%Y-%m-%d_%H:%M:%S")
echo "*** devicesettings..."
if [[ $src_init -eq 1 ]]; then
cd ~/src_M2_LOS151
...
printf "\033]2;%s Sync LineageOS 15.1 - ExtendedSettings...\007" $(date +"%Y-%m-%d_%H:%M:%S")
...
printf "\033]2;%s Sync LineageOS 15.1 - device-sony-eagle...\007" $(date +"%Y-%m-%d_%H:%M:%S")
...
printf "\033]2;%s Sync LineageOS 15.1 - device-sony-yukon...\007" $(date +"%Y-%m-%d_%H:%M:%S")
...
printf "\033]2;%s Sync LineageOS 15.1 - vendor-sony-yukon...\007" $(date +"%Y-%m-%d_%H:%M:%S")
...
printf "\033]2;%s Sync LineageOS 15.1 - kernel...\007" $(date +"%Y-%m-%d_%H:%M:%S")
echo "*** kernel..."
if [[ $src_init -eq 1 ]]; then
cd ~/src_M2_LOS151
...
printf "\033]2;%s Sync LineageOS 15.1 - end\007" $(date +"%Y-%m-%d_%H:%M:%S")
cd ~/src_M2_LOS151
