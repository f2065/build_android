...
echo "*****************************************************************************"
echo "*****************************************************************************"
echo "M2 Sources. Sync LineageOS 14.1"
...
if [[ $src_init -eq 1 ]]; then
cd ~/src_M2_LOS141
git clone https://github.com/LineageOS/android_external_sony_boringssl-compat -b cm-14.1 external/sony/boringssl-compat
else
cd ~/src_M2_LOS141/external/sony/boringssl-compat
git pull
fi
...
if [[ $src_init -eq 1 ]]; then
cd ~/src_M2_LOS141
git clone https://github.com/LineageOS/android_hardware_sony_timekeep -b cm-14.1 hardware/sony/timekeep
else
cd ~/src_M2_LOS141/hardware/sony/timekeep
git pull
fi
...
cd ~/src_M2_LOS141/device/qcom/common
git pull
fi
...
if [[ $src_init -eq 1 ]]; then
cd ~/src_M2_LOS141
git clone https://github.com/LineageOS/android_device_sony_common -b cm-14.1 device/sony/common
else
cd ~/src_M2_LOS141/device/sony/common
git pull
fi
...
if [[ $src_init -eq 1 ]]; then
cd ~/src_M2_LOS141
git clone https://github.com/LineageOS/android_hardware_sony_macaddrsetup -b cm-14.1 hardware/sony/macaddrsetup
else
cd ~/src_M2_LOS141/hardware/sony/macaddrsetup
git pull
fi
...
# if [[ $src_init -eq 1 ]]; then
# cd ~/src_M2_LOS141
# git clone https://github.com/LineageOS/android_hardware_sony_thermanager -b cm-14.1 hardware/sony/thermanager
# else
# cd ~/src_M2_LOS141/hardware/sony/thermanager
# git pull
# fi
...
cd ~/src_M2_LOS141/packages/resources/devicesettings
git pull
fi
...
if [[ $src_init -eq 1 ]]; then
cd ~/src_M2_LOS141
git clone https://github.com/sonyxperiadev/packages_apps_ExtendedSettings -b n-mr1 packages/apps/ExtendedSettings
else
cd ~/src_M2_LOS141/packages/apps/ExtendedSettings
git pull
fi
...
if [[ $src_init -eq 1 ]]; then
cd ~/src_M2_LOS141
git clone https://github.com/f2065/device-sony-eagle -b cm-14.1 device/sony/eagle
else
cd ~/src_M2_LOS141/device/sony/eagle
git pull
fi
...
if [[ $src_init -eq 1 ]]; then
cd ~/src_M2_LOS141
git clone https://github.com/f2065/device-sony-yukon -b cm-14.1 device/sony/yukon
else
cd ~/src_M2_LOS141/device/sony/yukon
git pull
fi
...
if [[ $src_init -eq 1 ]]; then
cd ~/src_M2_LOS141
git clone https://github.com/f2065/vendor-yukon -b cm-14.1 vendor/sony
else
cd ~/src_M2_LOS141/vendor/sony
git pull
fi
...
cd ~/src_M2_LOS141/kernel/sony/msm8226
git pull
fi
